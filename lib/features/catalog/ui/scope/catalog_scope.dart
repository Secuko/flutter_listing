...
class CatalogScope extends StatelessWidget {
  ...
  static ScopeData<bool> get isEmptyState => _scope.select((state)=> state.isEmpty);

  static Stream<CatalogState> streamOf(BuildContext context) => _scope.bloc(context).stream;
  ...
  static void load(BuildContext context) {
   ...
   static void refresh(BuildContext context) {
    ...
    _scope.bloc(context).add(const CatalogEventClear());
  }

  static void loadMore(BuildContext context){
    _scope.bloc(context).add(const CatalogEventLoadMore());
  }
